...
//                throw new HttpResponseException($response);
        ...
        $controller = $convert ? strtolower($controller) : $controller; if (!preg_match('/^[A-Za-z](\w|\.)*$/', $controller)) {
            throw new HttpException(404, 'controller not exists:' . $controller);
//        $result = [
//            'code' => 2,
//            'msg'  => 'controller not exists:' . $controller,
//            'data' => '',
//            'url'  => '',
//            'wait' => 3,
//        ];
...
//            $result = [
//                'code' => 2,
//                'msg'  => 'controller not exists:' . $e->getClass(),
//                'data' => '',
//                'url'  => '',
//                'wait' => 3,
//            ];
...
//            $result = [
//                'code' => 2,
//                'msg'  => 'method not exists:' . get_class($instance) . '->' . $action . '()',
//                'data' => '',
//                'url'  => '',
//                'wait' => 3,
//            ];
