...
$(function () {
    $("#priceSearch").click(function () {
        ...
        if ($("#weight").val() == "" && ($("#chang").val() == "" && $("#kuan").val() == "" && $("#gao").val() == "")) {
            mess("red", "The weight or volume of the item cannot be empty at the same time!");
    ...
    function mess(color, text) {
        $("#The weight or volume of the item cannot be empty at the same time!").html("<font color='" + color + "'>" + text + "</font><br/><br/><br/>");
    }
    //四舍五入
