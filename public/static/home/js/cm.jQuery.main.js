$(function(){
	...
	function slideThumbCommon(){
		...
		$('#wrap.main .thumb_slide li.on a').css({'opacity' : 0.3}).stop().animate({'opacity':1}, 1500, $easing); // ������ �̹��� opacity ����
	...
	function movieInsert(){
		$('#wrap.main .thumb_layer .popup_visual.movie').addClass('active')
			.html('<iframe width="900" height="500" title="�̷����´�� �׷�Ұ� ����" src="https://www.youtube.com/embed/0LlXTGCjs6I?rel=0" frameborder="0" allowfullscreen></iframe>');
			// .html('<iframe width="900" height="500" title="�̷����´�� �׷�Ұ� ����" src="https://www.youtube.com/embed/jo5FuvW3iOM" frameBorder="0" allowfullscreen="true" ></iframe>');
